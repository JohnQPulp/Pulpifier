...
public static partial class Compiler {
				...
				while (rawLine != constructedLine || (r + 2 == rawLines.Length && p < pulpLines.Length)) {
					...
					if (speakerCounterOverride != null) {
						if (activeSpeaker != "") {
							...
							characterCounterOverrides[activeThinker] = speakerCounterOverride;
						} else {
							throw new Exception("Bad speaker override.");
						}
					}
	...
	// pyftsubset "NotoSerif[wdth,wght].ttf" --unicodes="U+0000-017F,U+0300-03ff,U+2000-206f,U+2150-218b" --layout-features="*" --flavor="woff2" --output-file="NotoSerif-Variable-Pulp.woff2"
	// pyftsubset "NotoSerif-Italic[wdth,wght].ttf" --unicodes="U+0000-017F,U+0300-03ff,U+2000-206f,U+2150-218b" --layout-features="*" --flavor="woff2" --output-file="NotoSerif-Italic-Variable-Pulp.woff2"
	[GeneratedRegex("^[\u0000-\u017f\u0300-\u03ff\u2000-\u206f\u2150-\u218b]*$")]
